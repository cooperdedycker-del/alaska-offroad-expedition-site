    ...
    <div className="min-h-screen bg-neutral-950 text-neutral-100">
      <header className="sticky top-0 z-40 backdrop-blur supports-[backdrop-filter]:bg-neutral-950/70">
        <div className="mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
          ...
          <a href="#trip-builder" className="inline-flex items-center gap-2 rounded-2xl bg-white/10 px-4 py-2 text-sm font-semibold hover:bg-white/20 transition">Book an Expedition</a>
        </div>
      </header>
  ...
  return (
    <section className="relative">
      <div className="absolute inset-0">
        <img src="/images/hero-illustration.png" alt="Alaska mountains" className="h-full w-full object-cover opacity-60"/>
      </div>
      <div className="relative mx-auto max-w-7xl px-4 py-28 md:py-40">
        <div className="max-w-3xl">
          ...
          <p className="mt-5 text-lg text-neutral-200">Premium, guided off-road expeditions across Alaska. Expedition-built Offroad vehecles, expert guides, and bucket-list add-ons like glacier treks and helicopter flyovers. We plan it all. You show up.</p>
          <div className="mt-8 flex flex-wrap gap-3">
            <a href="#trip-builder" className="rounded-xl bg-white text-neutral-900 px-5 py-3 font-semibold hover:bg-neutral-200">Build Your Trip</a>
            <a href="#experiences" className="rounded-xl border border-white/30 px-5 py-3 font-semibold hover:bg-white/10">See Experiences</a>
          </div>
  ...
  return (
    <section className="border-y border-white/5 bg-neutral-900/40">
      <div className="mx-auto max-w-7xl px-4 py-6 grid grid-cols-2 md:grid-cols-4 gap-4 text-sm text-neutral-300">
        ...
        <div>✔ Expedition-built Jeep fleet</div>
      ...
      <div className="mt-8 grid gap-6 md:grid-cols-3">
        {cards.map((x, i) => (
          <div key={i} className="group relative overflow-hidden rounded-2xl border border-white/10 bg-neutral-900/40">
            <img src={x.img} alt={x.title} className="h-44 w-full object-cover opacity-80 group-hover:scale-105 transition duration-500" />
            <div className="p-5">
    ...
    <section id="fleet" className="mx-auto max-w-7xl px-4 py-16">
      ...
      <div className="mt-8 grid gap-6 md:grid-cols-2">
        <div className="rounded-2xl overflow-hidden border border-white/10 bg-neutral-900/40">
          <img src="\images\Wrangler140.jpg" alt="Jeep on trail" className="h-64 w-full object-cover"/>
          <div className="p-5">
        ...
        <div className="rounded-2xl overflow-hidden border border-white/10 bg-neutral-900/40">
          <img src="\images\tacomaone40.jpeg" alt="Camp under northern lights" className="h-64 w-full object-cover"/>
          <div className="p-5">
  ...
  return (
    <section id="about" className="mx-auto max-w-7xl px-4 py-16">
      <div className="grid md:grid-cols-2 gap-10 items-start">
        ...
        <div className="rounded-2xl overflow-hidden border border-white/10 bg-neutral-900/40">
          <img src="\images\expedition2.bmp" alt="Glacier valley" className="w-full h-72 object-cover"/>
